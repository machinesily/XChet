	...
	<view>
		<view class="send">
			<view class="chet-send">
				...
				<textarea auto-height="true" class="chat-input btn" v-show="!isrecord" @input="inputs" v-model="msg" cursor-spacing="20" />
			...
			<view class="more" v-show="isMore">
				...
				<view class="more-list">
					<image src="../../static/images/chatRoom/location.png" mode="" />
